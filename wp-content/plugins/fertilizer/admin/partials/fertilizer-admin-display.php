 ...
 *
 * @package    Fertilizer
 * @subpackage Fertilizer/admin/partials
 */
?>
...
<div class="wrap">
    ...
    <form method="post" name="cleanup_options" action="options.php">
        ...
        <fieldset>
            ...
            <div id="upload_logo_preview" class="fertilizer-upload-preview <?php if(empty($login_logo_id)) echo 'hidden'?>">
                <img src="<?php echo $login_logo_url; ?>" />
                <button id="fertilizer-delete_logo_button" class="fertilizer-delete-image">X</button>
            </div>
        </fieldset>

        <!-- login background color-->
        <fieldset class="fertilizer-admin-colors">
